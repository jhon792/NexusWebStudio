...
const plans = [
  {
    ...
    label: "Para empezar a captar clientes",
    tagline: "Tu negocio visible en Google desde el primer mes",
    price: 450,
    priceLabel: null,
    currency: "EUR",
    ...
    description: "Para despachos, clínicas y pymes en España que necesitan presencia web profesional y comenzar a recibir consultas por Google.",
    features: [
      "Diseño web profesional responsive",
      "SEO técnico inicial — metatags, estructura, velocidad",
      "Alta en Google Search Console y Google Maps",
      "Google Analytics 4 configurado desde el día 1",
      "SSL incluido + formularios de contacto",
      "WhatsApp Business integrado",
      "Velocidad optimizada (Lighthouse +90)",
      "Hasta 5 páginas completas",
      "Dominio .es o .com incluido 1 año",
  ...
  },
  {
    ...
    badge: "⭐ MÁS ELEGIDO",
    name: "Plan Premium",
    label: "La opción más completa",
    tagline: "El preferido por abogados, clínicas e inmobiliarias en España",
    price: 790,
    priceLabel: null,
    currency: "EUR",
    delivery: "21 a 30 días hábiles",
    accent: "#a78bfa",
    featured: true,
    ...
    socialProof: "El plan más elegido por profesionales en España",
    languages: ["🇪🇸 Español", "🇬🇧 English", "🇫🇷 Français", "🇩🇪 Deutsch"],
    languageNote: "Hasta 4 idiomas incluidos",
    description: "Diseñado para negocios en España que quieren dominar Google en su sector y captar clientes de forma constante. Con IA, SEO avanzado y hasta 4 idiomas.",
    features: [
      "Todo lo del Plan Profesional incluido",
      "SEO avanzado on-page + estrategia de link building",
      "Blog con 10 artículos SEO iniciales redactados",
      "Landing page específica por sector de negocio",
      "Chatbot con IA para captación automática de leads",
      "Integración CRM (HubSpot u equivalente gratuito)",
      "GEO SEO: visible en ChatGPT, Gemini y Claude",
      "Reportes mensuales de posicionamiento en Google",
      "Estrategia de captación de leads 3 meses",
      "Soporte prioritario 3 meses",
      "Hasta 4 idiomas: ES + EN + FR + DE",
    ],
    missing: [],
  },
  {
    ...
    tagline: "Funcionalidades únicas para tu despacho o empresa",
    price: 0,
    ...
    dailyCost: null,
    socialProof: null,
    languages: ["Idiomas a medida"],
    languageNote: "Multiidioma sin límite",
    description: "Para despachos y empresas que necesitan algo único: sistema de citas online, portal de clientes, automatizaciones avanzadas o plataforma completamente a medida.",
    features: [
      "Todo lo del Plan Premium incluido",
      "Desarrollo web completamente a medida",
      "Sistema de citas o reservas online integrado",
      "Portal privado de clientes (área personal)",
      "Automatizaciones avanzadas con IA generativa",
      "Integración con CRM, ERP o software propio",
      "Panel de administración propio sin dependencias",
      "SEO avanzado multiidioma sin límite de idiomas",
      "Estrategia de contenido y posicionamiento 6 meses",
      "Soporte prioritario dedicado 6 meses",
      "Escalabilidad y crecimiento garantizados",
...
const standards = [
  ...
  { Icon: Zap, label: "Carga ultrarrápida", tooltip: "Cada segundo de demora hace que pierdas clientes. Tu web está optimizada para cargar en menos de 2 segundos y aparecer mejor en Google." },
  { Icon: Search, label: "Visible en Google", tooltip: "Configuramos la web para que Google la encuentre y la muestre cuando alguien busca tu servicio en España. Sin esto tu web existe pero nadie la ve." },
  ...
  { Icon: Globe, label: "SEO técnico", tooltip: "Sitemap, hreflang, canonicals y robots.txt configurados. Le decimos a Google todo lo que necesita saber para indexar correctamente tu web." },
  { Icon: Languages, label: "Multiidioma", tooltip: "Hasta 4 idiomas en el Plan Premium. Hreflang correcto para SEO internacional. Cada versión idiomática tiene su propio URL y está indexada en Google." },
  { Icon: Lock, label: "Protección activa", tooltip: "Tu web está protegida contra ataques comunes en internet. La información de tus visitantes siempre segura según el RGPD." },
  { Icon: Monitor, label: "Todos los navegadores", tooltip: "Funciona en Chrome, Safari, Firefox y Edge. Compatible con cualquier dispositivo o navegador que usen tus clientes en España." },
  { Icon: Eye, label: "Centrado en conversión", tooltip: "Cada botón, sección y texto tiene un objetivo claro: que el visitante te llame, rellene el formulario o te escriba. ROI desde el primer mes." },
];
  ...
  return (
    <div className="mb-4">
      ...
      <p style={{ fontFamily: "Inter, sans-serif", fontSize: 11, color: "rgba(255,255,255,0.35)", display: "flex", alignItems: "center", gap: 4 }}>
        <Languages size={11} style={{ color: "#818cf8" }} />
        {note}
      </p>
    </div>
  );
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <span style={{ background: "linear-gradient(135deg, #818cf8, #a78bfa, #c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                Nosotros entregamos lo mismo desde 450 €.
              </span>
            </motion.h2>
            ...
            >
              Inversión única. Sin mensualidades. El 90% de nuestros clientes recuperan la inversión con el primer cliente captado a través de la web.
            </motion.p>
                  ...
                  <div className="mb-4">
                    {plan.price > 0 ? (
                      <>
                        ...
                        <p style={{ fontFamily: "Inter, sans-serif", fontSize: "12px", color: "rgba(255,255,255,0.3)", marginTop: "5px" }}>EUR · pago único, sin mensualidades</p>
                      </>
                    ) : (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <p style={{ fontFamily: "Inter, sans-serif", fontSize: "14px", color: "rgba(255,255,255,0.45)", lineHeight: 1.5 }}>
                ...
                <span style={{ color: "rgba(255,255,255,0.65)" }}>El <strong style={{ color: "#a78bfa" }}>Plan Premium</strong> fue diseñado exactamente para tu sector.</span>
              </p>
            </div>
            <motion.a
              href={WA}
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "14px", color: "rgba(255,255,255,0.35)", lineHeight: 1.6 }}>
              Pasa el cursor sobre cada elemento para saber qué significa para tu negocio en España.
            </p>
          </motion.div>
