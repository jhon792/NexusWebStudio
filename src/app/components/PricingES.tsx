...
const plans = [
  {
    ...
    socialProof: null,
    languages: ["🇪🇸 Español"],
    languageNote: "1 idioma — solo español",
    ...
    missing: [
      ...
      "Solo disponible en español (1 idioma)",
    ],
  },
  {
    id: "profesional",
    ...
    languages: ["🇪🇸 Español", "🇬🇧 English", "🇫🇷 Français", "🇮🇹 Italiano"],
    languageNote: "4 idiomas — tú eliges cuáles",
  ...
  },
  {
    ...
    dailyCost: null,
    socialProof: null,
    languages: ["🌐 Idiomas sin límite"],
    languageNote: "Sin límite de idiomas",
    ...
    features: [
      ...
      "Multiidioma — idiomas sin límite",
